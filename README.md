This page records LDP datasets generated by <a href="https://github.com/noorbakerally/BlazeLDP">BlazeLDP</a> and deployed via an LDP using <a href="https://github.com/noorbakerally/InterLDP">InterLDP</a>. The generation of these LDP datasets and their deployment occured in the following scenarios:

1. Data portals in countries
2. Parking in Grenoble
3. DCAT catalogs from data portals in France 

All LDPs mentioned on this page can be browsed using <a href="https://github.com/noorbakerally/GeminiLDP">GeminiLDP</a> (our LDP browser)
